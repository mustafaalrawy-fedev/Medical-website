...
const MobileRegisterPage = ({ slide }) => {
  return (
    <>
      <motion.section
        animate={slide ? { opacity: 1, x: 0 } : { opacity: 0, x: -50 }}
        className='flex flex-col gap-7 w-full items-center justify-center absolute left-0 bottom-20 h-1/2'
      >
